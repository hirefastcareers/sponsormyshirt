-- =============================================================================
-- Optional sponsor X (Twitter) handle on sponsorship_slots
...
DROP FUNCTION IF EXISTS public.hold_title_takeover(text, text, text, boolean, boolean, text);
...
DROP FUNCTION IF EXISTS public.sell_title_takeover(text, text, text, boolean, boolean, text);
...
REVOKE ALL ON FUNCTION public.hold_title_takeover(text, text, text, boolean, boolean, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.sell_title_takeover(text, text, text, boolean, boolean, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.release_title_takeover_hold() FROM PUBLIC;

GRANT EXECUTE ON FUNCTION public.hold_title_takeover(text, text, text, boolean, boolean, text) TO service_role;
GRANT EXECUTE ON FUNCTION public.sell_title_takeover(text, text, text, boolean, boolean, text) TO service_role;
